...
public class App {
    ...
    public App(LoginManager login, String pkgName) throws IOException {
        this.login = login;
...
//                request.setEntity(new UrlEncodedFormEntity(data, Consts.UTF_8));
                request.setEntity(new UrlEncodedFormEntity(data, Consts.UTF_8.toString()));
            }
    ...
    public GooglePlay.AndroidAppDeliveryData deliver() throws IOException {
        ArrayList<NameValuePair> opt = new ArrayList<NameValuePair>();
    ...
    public void download(GooglePlay.AndroidAppDeliveryData data, String outFile) throws IOException {
