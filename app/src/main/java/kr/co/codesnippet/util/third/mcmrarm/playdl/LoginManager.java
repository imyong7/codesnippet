...
public class LoginManager {
    ...
    public LoginManager(String service, String app) {
    ...
    public void login(String password, String androidId) throws IOException, LoginException {
        if (auth != null)
            return;
        ...
        if (androidId != null) args.add(new BasicNameValuePair("androidId", androidId));
...
//        post.setEntity(new UrlEncodedFormEntity(args, Consts.UTF_8));
        post.setEntity(new UrlEncodedFormEntity(args, Consts.UTF_8.toString()));
